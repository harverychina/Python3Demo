...
# 订单路径
download_path = "/Users/huangjiancong/Desktop/Python3Demo/Python自动化办公实战/新年特辑/订单"
...
# 用每个excel的文件名区分月份
print(f"月份为:{file.stem} 本月水果销售 Top3为:")
